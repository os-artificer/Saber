...
type DiscoveryConfig struct {
	...
	DialTimeout           time.Duration `yaml:"dialTimeout"`           // seconds
	AutoSyncInterval      time.Duration `yaml:"autoSyncInterval"`      // seconds
	DialKeepAliveTime     time.Duration `yaml:"dialKeepAliveTime"`     // seconds
	DialKeepAliveTimeout  time.Duration `yaml:"dialKeepAliveTimeout"`  // seconds
